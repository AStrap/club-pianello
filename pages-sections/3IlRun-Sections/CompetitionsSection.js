    ...
    <div className={classes.section}>
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <h3 className={classes.title} style={{margin:"0px"}}>27.04.2025</h3>
          <h3 className={classes.description} style={{margin:"0px"}}>II Ed. - 2,5K D+ 400</h3>
          <Button
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <h3 className={classes.title} style={{margin:"0px"}}>25.05.2025</h3>
          <h3 className={classes.description} style={{margin:"0px"}}>III Ed. - 10K D+ 400 / - 25K D+ 1.500</h3>
          <Button
            href="https://www.visitvalsugana.it/it/landing-esperienze/#/esperienze/TRN/f3de36c6-fdcd-46bd-93c3-3e06a562f699/valsugana-color-run"
            color="transparent"
            className={classes.navLink}
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <h3 className={classes.title} style={{margin:"0px"}}>31.05.2025</h3>
          <h3 className={classes.description} style={{margin:"0px"}}>II Ed. - 10K D+ 400</h3>
          <Button
            href="https://www.visitvalsugana.it/it/landing-esperienze/#/esperienze/TRN/f3de36c6-fdcd-46bd-93c3-3e06a562f699/valsugana-color-run"
            color="transparent"
            className={classes.navLink}
